  ...
  <div class="container shadow col-xxl-8 px-5 py-5 bg-white rounded-3">
    <div class="row flex-lg-row-reverse align-items-center justify-content-center g-5 py-5">
      ...
      <div class="col-lg-6">
        ...
        <p class="lead">Het Segbroek College presenteert: LitList! Op deze site vindt je alle boeken van de literatuurlijst van het Segbroek. Gebruik de zoekfilters om het boek te vinden dat bij jou past.</p>
