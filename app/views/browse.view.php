        ...
        <div class="ll-card h-100 mx-auto pt-3 pb-2 border-top">
          <div class="row g-0">
            ...
            <div class="col-2 ll-card-img">
              <a href="<?= ROOT ?>/book?id=<?= esc($book["bookId"]) ?>"><img src="<?= esc($book["imageLink"]) ?>" alt="<?= esc($book["title"]) ?>"></a>
            </div>

            <!-- Middle-->
            <div class="col-8 ll-card-middle">
              <a href="<?= ROOT ?>/book?id=<?= esc($book["bookId"]) ?>" class="ll-card-title"><?= esc($book["title"]) ?></a>
